...
$result = $dbComObj->viewData($conn, "`orders`", "*", "1 and `user_id`='" . $login_id . "'");
                        ...
                        <div class="large-left col-sm-12">
                            <div class="row">
                                <div id="center_column" class="center_column col-xs-12 col-sm-9 accordionBox">
                                    <div class="box">
                                        <h1 class="page-subheading">Welcome <span style="font-style: italic;"><?php echo $_SESSION['user_name']; ?></span></h1>
                                        <?php // print_r($_SESSION);  ?>

                                        <div class="container-fluid">
                                            <div class="quick-actions_homepage">
                                                <ul class="quick-actions">
                                                    <li class="bg_lb"> <a href="<?php echo BASE_URL; ?>user/<?php echo $login_name; ?>/my-account/"> <i class="fa fa-dashboard"></i> My Dashboard </a> </li>
                                                    <li class="bg_ly"> <a href="<?php echo BASE_URL; ?>user/<?php echo $login_name; ?>/personal-info/"> <i class="fa fa-user-plus"></i> Personal Info </a> </li>
                                                    <li class="bg_lg"> <a href="<?php echo BASE_URL; ?>user/<?php echo $login_name; ?>/my-order/"> <i class="fa fa-cart-arrow-down"></i> <span class="label label-important"><?php echo $num; ?></span>Manage Orders</a> </li>
                                                    <!--<li class="bg_lh"> <a href="<?php echo BASE_URL; ?>user/my-upload-prescription/"> <i class="fa fa-medkit"></i>Manage Prescription</a> </li>-->
                                                    <li class="bg_lr"> <a href="<?php echo BASE_URL; ?>user/<?php echo $login_name; ?>/change-password/"> <i class="fa fa-key"></i> Password</a> </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <ul class="footer_links clearfix">
                                        <li><a class="btn btn-secondary btn-sm icon-left" href="<?php echo BASE_URL; ?>user/<?php echo $login_name; ?>/my-account/" title="Back to your account"><span>Back to your Account</span></a></li>
