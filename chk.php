                            ...
                            <div class="delivere" >
                                ...
                                <form class="form-bordered" method="post" id="userForm">
                                    <div id="billing_address">
                                        ...
                                        if ($num_adr > 0) {
                                            ...
                                            while ($address = $dbComObj->fetch_object($result_adr)) { //print_r($address)
                                                ?>
                                                <div class="col-md-6 foundation" id="address_b<?Php echo $address->id ?>">
                                                    ...
                                                    <div class="foundation_sm">      
                                                        ...
                                                        <button class="btn btn-success center " onclick="return deleteAddress('<?Php echo $address->id ?>');" id="addressremove"   >REMOVE </button>
                                    ...
                                    <label for="foroneregister" style="font-size: 16px !important;"><b>Tick to deliver to New billing address above </b> </label></p>
                                     ...
                                     <?php } ?>
                                       <div id="add_new_address"  class="col-md-12 col-sm-12" <?php if($num_adr > 0) echo  'style="display: none;"';else  echo  'style="display: block;"'  ?>>
                                    ...
                                    <div class="">
                                        ...
                                        if ($cartItems) { //print_r($cartItems);
                                                        ...
                                                        <div class="full-width margintop10 border-bottmo">
                                                            <div class="col-md-6 col-sm-6">
                                                                ...
                                                                <div class="col-md-9 col-sm-9">
                                                                    ...
                                                                    <p><?php echo $ajGenObj->NameById($item->Brand, 'brands'); // echo $data->Brand;      ?></p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-sm-3">
                                            ...
                                            <div class="col-md-12 col-sm-12 margintop10 border-bottmo">
                                                <p> Delivered to you in by Friday, 04th Aug 2017. </p>
                                            </div>
                                            <div class="full-width margintop10 border-bottmo">
                                                <div class="col-md-6 col-sm-6">
                                                    <p>Subtotal</p>
                                                ...
                                                <div class="col-md-6 col-sm-6 text-right">
                                                    <p> <?php echo CURRENCY_SYMBOL . number_format($subtotalR, 2); ?> </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="full-width margintop10 border-bottmo">
                                                ...
                                                <div class="col-md-6 col-sm-6 text-right">
                                                    <p><?php echo CURRENCY_SYMBOL . number_format($Shipping_charge, 2); ?></p>
                                                </div>
                                            </div>
                                            <div class="full-width margintop10">
                                                <div class="col-md-6 col-sm-6">  
                                                ...
                                                <div class="col-md-6 col-sm-6 text-right">
                                                  <p> <?php echo CURRENCY_SYMBOL . number_format($totalpriceR, 2); ?> </p>
                                                </div>
                                            </div>
                                        <?php } else {
...
<!--                                                        <h4 class="hadding text-left">Designer:<?php// echo $ajGenObj->NameById($item->Brand, 'brands'); // echo $data->Brand;      ?></h4>-->
                                    ...
                                    <p class="margin0 pull-right">(Import duties included)</p>
                                <?php }else {
                                    echo '<h2 align= "center">Your cart is Empty</h2>';
                                    ?>
                                    <a href="<?php echo BASE_URL; ?>grid/" style="float:right;" class="btn btn-default ">Continue Shoping</a>
