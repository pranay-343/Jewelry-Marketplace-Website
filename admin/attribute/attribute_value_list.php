...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="<?php echo ADMIN_URL; ?>attribute/add-attribute/" class="btn btn-sm btn-info btn-growl" data-growl="info"><i class="fa fa-pencil fa-fw"></i> Add New Attribute</a></li>
         <li><a href="<?php echo ADMIN_URL; ?>attribute/add-attribute-value/" class="btn btn-sm btn-info btn-growl" data-growl="info"><i class="fa fa-pencil fa-fw"></i>Add Attribute value</a></li>
