...
$site_title = "Admin View Users | Jewelry at Home";
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-group"></i>Manage your User's<br><small>Add / Edit / Delete here!</small>
            </h1>
        </div>
    </div>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo ADMIN_URL;?>user/users_data.php?a=list" data-query-params="queryParams"
...
{
    var cr = confirm("Are you sure to delete this User?");
     if(cr){
