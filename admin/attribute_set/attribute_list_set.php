...
$site_title = "Admin Attribute | Manage Attribute set | MarketPlace at Home";
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-notes_2"></i>Manage Attribute Set List <br><small>Manage edit / delete / add Attribute Set!</small>
            </h1>
        </div>
    </div>
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="<?php echo ADMIN_URL; ?>attribute/add-attribute-set/" class="btn btn-sm btn-info btn-growl" data-growl="info"><i class="fa fa-pencil fa-fw"></i> Add New Attribute Set</a></li>
        <li>View Attribute  Set List</li>
    </ul>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo ADMIN_URL;?>attribute_set/fetchinfDataFromTables.php?a=attribute" data-query-params="queryParams"
...
<script>
function deleteAttributeSet(a)
{
   var cr = confirm("Are you sure to delete this attribute Set?");
   if(cr){
      $.post('<?php echo ADMIN_URL;?>attribute_set/attribute_set_operations.php',{a:a,todo:'<?php echo base64_encode('deleteAttributeSet');?>'},function(data){
       // $('#errorMsg').html(data);
...
function ManageByAdmin(a,b)
{
  ...
  $.post('<?php echo ADMIN_URL;?>attribute_set/attribute_set_operations.php',{a:a,b:b,todo:'<?php echo base64_encode('statusAttributeSet');?>'},function(data){
    //  $('#errorMsg').html(data);
    alert('Attribute Set '+txt+' successfully.');
    window.location.reload();
    return false;
  });
