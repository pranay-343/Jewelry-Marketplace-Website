...
if ($operation == "addBrand") {
    ...
    if ($num == 0) {
        ...
        echo "Reload : Brand added successfully.";
    } else {
        echo "Error : Brand already exist.";
    }
} elseif ($operation == "editBrand") {
    ...
    if ($num == 0) {
       ...
       // echo "Reload : Brand updated successfully.";
           echo "Redirect : Brand updated successfully. URL ".ADMIN_PATH."brands/";
    } else {
        echo "Error : Brand already exist.";
    }
} 
