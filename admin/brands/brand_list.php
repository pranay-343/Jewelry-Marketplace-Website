...
$site_title = "Admin Brands | Manage Brands | MarketPlace at Home";
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-notes_2"></i>Manage Brands List <br><small>Manage edit / delete / add Brands!</small>
            </h1>
        </div>
    </div>
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="<?php echo ADMIN_URL; ?>brands/add-brand/" class="btn btn-sm btn-info btn-growl" data-growl="info"><i class="fa fa-pencil fa-fw"></i> Add New Brands</a></li>
        <li>View Brands List</li>
    </ul>
                    ...
                    <div class="x_content"><div id="result1"></div>
                        <div class="table-responsive">
                            <table id="testTable" class="table table-vcenter table-condensed table-bordered" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                                   ...
                                   data-show-footer="true" data-height="400" data-url="<?php echo ADMIN_URL; ?>brands/fetchinfDataFromTables.php?a=brands" data-query-params="queryParams"
...
<script>
    ...
    {
        var cr = confirm("Are you sure to delete this Brand?");
        if (cr) {
            $.post('<?php echo ADMIN_URL; ?>brands/brand_operations.php', {a: a, todo: '<?php echo base64_encode('deleteBrand'); ?>'}, function (data) {
                // $('#errorMsg').html(data);
    ...
    function BrandManageByAdmin(a, b)
    {
        var txt = '';
        if (b == '1') {
            txt = 'Deactivate';
        ...
        $.post('<?php echo ADMIN_URL; ?>brands/brand_operations.php', {a: a, b: b, todo: '<?php echo base64_encode('statusBrand'); ?>'}, function (data) {
            //  $('#errorMsg').html(data);
            alert('Brand ' + txt + ' successfully.');
            window.location.reload();
            return false;
        });
