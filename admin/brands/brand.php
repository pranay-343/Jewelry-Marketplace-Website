...
$site_title = "Admin eCommerce | Manage Brand | MarketPlace at Home";
...
if (isset($_GET['a'])) {
    ...
    if ($num) {
        ...
        header('Location:' . ADMIN_PATH . 'brands/');
    }
}
?>
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-notes_2"></i><?php echo $txt; ?> Brands's  Here
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="<?php echo ADMIN_URL; ?>dashboard/">Dashboard</a></li>
        <li><a href="<?php echo ADMIN_URL; ?>brands" class="btn btn-sm btn-info btn-growl" data-growl="info"><i class="fa fa-pencil fa-fw"></i>View Brands List</a></li>
        <li><?php echo $txt; ?> Brands</li>
    </ul>
        ...
        <div class="col-sm-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><?php echo $txt; ?> Your Brands's  Here</h2>
                </div>
                ...
                <form class="form-horizontal form-bordered" id="form_category" enctype="multipart/form-data" method="post" data-parsley-validate>
                    <div id="container">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <?php
                                if ($id != "") {
                                    $srcc = "../../images/category/" . $image;
                                    if (is_file($srcc)) {
                                        $srcc = BASE_PATH . "images/category/" . $image;
                                        $img = '<img src="' . $srcc . '" alt="' . $image . '" title="' . $image . '" width="100px" />';
                                        echo $img . "<br />&nbsp;";
                                    } else {
                    ...
                    <div class="form-group form-actions">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <?php } ?>
                            <button type="button" onclick="formSubmit('form_category', 'result_category', '<?php echo ADMIN_URL; ?>brands/brand_operations.php')" class="btn btn-success srSubmitBtn">Submit</button>
                        </div>
                    </div>
                </form>
