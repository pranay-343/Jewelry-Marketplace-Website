...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-group"></i> Contest Products Votes (<?php echo  ucfirst($ajGenObj->NameById($id,'contests','title')); ?>)<br><small></small>
            </h1>
        </div>
    </div>
    ...
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="">Dashboard</a></li>
          <li>View Contest Product Votes</li>
         ...
         <li><a href="<?php echo ADMIN_URL; ?>contests/pending_contest_participate/" class="btn btn-alt btn-xs btn-primary"><i class="hi hi-eye-open"></i> View Pending Participate List</a></li>
               <li><a href="<?php echo ADMIN_URL; ?>contests/info/?session_uid=<?php echo $_REQUEST['session_uid'];?>" class="btn btn-alt btn-xs btn-primary"><i class="hi hi-eye-open"></i> View Participate</a></li>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo ADMIN_URL;?>contest/fetch_data.php?a=contestProductVotes&b=<?php echo $id;?>" data-query-params="queryParams"
