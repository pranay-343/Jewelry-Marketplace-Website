...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-group"></i>Manage your contest (<?php echo  ucfirst($ajGenObj->NameById($id,'contests','title')); ?>) particpate 's<br><small></small>
            </h1>
        </div>
    </div>
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li>View particpate List</li>
         ...
         <li><a href="<?php echo ADMIN_URL; ?>contests/product_votes_contest/?session_uid=<?php echo $_REQUEST['session_uid'];?>" class="btn btn-alt btn-xs btn-primary"><i class="hi hi-eye-open"></i> View Contest Product Votes</a></li>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo ADMIN_URL;?>contest/fetch_data.php?a=contestParticipate&b=<?php echo $id;?>" data-query-params="queryParams"
  data-pagination="true" data-search="true">
  <thead>
  <tr><th data-field="id" data-sortable="true">#</th>
  <th data-field="seller" data-sortable="true">Name</th>
