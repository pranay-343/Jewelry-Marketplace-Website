...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li>View Contest List</li>
           <li><a href="<?php echo ADMIN_URL; ?>contests/new-contest/" class="btn btn-alt btn-xs btn-primary"><i class="fa fa-plus"></i> Add contest</a></li>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo ADMIN_URL;?>contest/fetch_data.php?a=list" data-query-params="queryParams"
