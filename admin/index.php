        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                ...
                <h1 style="margin-top: 0px;">
                    <small style="text-transform:uppercase;">Please 
                        <strong>Login</strong> - 
                ...
                <form method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
                    ...
                    <div class="form-group form-actions">
						...
						<p class="margintop10"><input type="checkbox" name="remember" id="one">  <label for="one">Keep me logged in</label> </p>
                            ...
                            <button type="button" onclick="formSubmit('form-login', 'errorMessageLog', '<?php echo ADMIN_URL; ?>admin_operations.php')" class="btn btn-sm btn-primary my-coustm-btn-cs">
                                Login to Dashboard
                            </button>
                        </div>
                    </div>
                ...
                <form method="post" id="form-reminder" class="form-horizontal form-bordered form-control-borderless display-none">
                    ...
                    <div class="form-group form-actions">
                        <div class="col-xs-12 text-right">
                            ...
                            <button type="button" onclick="formSubmit('form-reminder', 'errorMessageLog', '<?php echo ADMIN_URL; ?>admin_operations.php')" class="btn btn-sm btn-primary my-coustm-btn-cs"> Reset Password </button>
                        </div>
                    </div>
