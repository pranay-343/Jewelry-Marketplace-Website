...
$site_title = "Admin View Products | Jewelry at Home";
...
<div id="page-content">
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="<?php echo ADMIN_URL;?>products/new-product/" class="btn btn-alt btn-xs btn-primary"><i class="fa fa-pencil"></i> Add New Product's</a></li>
         <li><a href="<?php echo ADMIN_URL;?>products/new-productcsv/" class="btn btn-alt btn-xs btn-primary"><i class="fa fa-pencil"></i> Add New Product's CSV</a></li>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo ADMIN_URL;?>products/product_data.php?a=list" data-query-params="queryParams"
