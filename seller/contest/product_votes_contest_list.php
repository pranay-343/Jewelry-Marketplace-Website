...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-group"></i> Contest Products Votes <small></small>
            </h1>
        </div>
    </div>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo SELLER_URL;?>contest/fetch_data.php?a=contestProductVotes&b=<?php echo $id;?>" data-query-params="queryParams"
  ...
  <th data-field="products" data-sortable="true">Products</th>
     <th data-field="contest_name" data-sortable="true">Contest</th>   
