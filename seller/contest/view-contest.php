...
$site_title = "seller View contest | Jewelry at Home";
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-group"></i>Manage your contest's<br><small>Add / Edit / Delete here!</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li><a href="">Dashboard</a></li>
        <li>View Contest List</li>
         </ul>
  ...
  data-show-footer="true" data-height="400" data-url="<?php echo SELLER_URL;?>contest/fetch_data.php?a=list" data-query-params="queryParams"
  data-pagination="true" data-search="true">
  <thead>
  <tr><th data-field="id" data-sortable="true">#</th>
   <th data-field="cover_image" data-sortable="true">Cover Image</th>
  <th data-field="title" data-sortable="true">Title</th>
  <th data-field="description" data-sortable="true">Description</th>
  <th data-field="added_on" data-sortable="true">Added</th>
    <th data-field="last_date" data-sortable="true">Last Date</th>
...
function DeleteContest(a)
{
    var cr = confirm("Are you sure to delete this Contest?");
     if(cr){
      $.post('<?php echo SELLER_URL;?>contest/contest_operations.php',{a:a,mode:'<?php echo base64_encode('deletecontest');?>'},function(data){
       // $('#errorMsg').html(data);
       // alert(data);
...
function UserManageByAdmin(a,b)
{
  ...
  $.post('<?php echo ADMIN_URL;?>contest/contest_operations.php',{a:a,b:b,mode:'<?php echo base64_encode('statusUpdate');?>'},function(data){
    //  $('#errorMsg').html(data);
