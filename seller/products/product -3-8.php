                        ...
                        <div class="well well-sm well-primary form-group">
                                ...
                                <div class="col-md-6">
                                     <div class="well well-sm well-primary form-group">
                                      ...
                                      <select class="form-control" id="sel1" name="attribute_set_id"   onChange="get_attribute(this.value);" required <?php echo $req; ?>>
                                  ...
                                  //  echo $category_id;
                                    ...
                                    <div class="well well-sm well-primary form-group" id="price_sec">
                                        ...
                                        <input type="number" min="0" id="price" name="price" title="Price is requreid" value="<?php echo $price; ?>" class="form-control" placeholder="price" required>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                     ...
                                     <div class="well well-sm well-primary">
                                        ...
                                        <input type="number" min="0"  required class="form-control validate-number" id="inventory_qty" name="inv_qty" value="<?php echo $inv_qty; ?>">
                                    </div>
                                    <div class="well well-sm well-primary">
    ...
    <div class="col-md-11 well well-sm well-primary">
        <div class="col-md-5">
            <div class="well well-sm well-primary">
                ...
                <input type="text" class="required-entry form-control" id="product_option_2_title" name="product_option_title[<?php echo $oid; ?>][]" value="<?php  echo $data_opt['title'] ?>"> </div>
        </div>
      
        <div class="col-md-3">
            <div class="well well-sm well-primary">
                <label for="grantpo">Is Required</label>
                <select name="option_is_requre[<?php echo $oid; ?>][]" id="product_option_2_is_require" class="form-control" title="">
        ...
        <div class="col-md-2">
            <div class="well well-sm well-primary">
                ...
                <input type="number" min="0" class="validate-zero-or-greater form-control" name="product_opt_sort_order[<?php echo $oid; ?>][]" value="<?php  echo $data_opt['sort_order'] ?>"> </div>
        </div>
        <div class="col-md-2">
                    ...
                    while ($data_val = $dbComObj->fetch_assoc($qry_val)) { 
                        ...
                        <div class="col-md-2">
                            <div class="well well-sm well-primary">
                                ...
                                <input type="number" min="0" class="required-entry form-control" id="product_option_2_title" name="opt_price_field[<?php echo $oid;?>][]" value="<?php  echo $data_val['price'] ?>"> </div>
                        </div>
                        <div class="col-md-2">
                            <div class="well well-sm well-primary">
                        ...
                        <div class="col-md-2">
                            <div class="well well-sm well-primary">
                                ...
                                <input type="number" min="0" class="validate-zero-or-greater form-control" name="opt_maxchar[<?php echo $oid;?>][]" value="<?php  echo $data_val['opt_maxchar'] ?>"> </div>
                        </div>
                        <div class="col-md-2">
                            <label for="grantpo"> </label> <a href="#" class="remove_field btn btn-danger">Remove</a> </div>
                    </div>
                    ...
                    <div class="option_select_row_val" id="option_select_row_val<?php  echo $oid?>">
                        <div class="col-md-11">
                            ...
                            <div class="col-md-2">
                                <div class="well well-sm well-primary">
                                    <label for="grantpo">Price *</label>
                                    <input type="number" min="0" class="required-entry form-control" id="product_option_2_title" name="opt_price_row[<?php echo $oid;?>][]" value="<?php  echo $data_val['price'] ?>"> </div>
                            </div>
                            <div class="col-md-2">
                                <div class="well well-sm well-primary">
                                    <label for="grantpo"> Price Type *</label>
                            ...
                            <div class="col-md-2">
                                <div class="well well-sm well-primary">
                                    <label for="grantpo">Sort Order </label>
                                    <input type="number" min="0" class="validate-zero-or-greater form-control" name="opt_sort_order_row[<?php echo $oid;?>][]" value="<?php  echo $data_val['opt_sort_order_row'] ?>"> </div>
                            </div>
                            <div class="col-md-2">
                                <label for="grantpo"> </label> <a href="#" class="remove_field btn btn-danger">Remove</a> </div>
                        </div>
