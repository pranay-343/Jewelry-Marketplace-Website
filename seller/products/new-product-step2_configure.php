...
<script>
  ...
  $(".associated_check").attr('required',true);
   });
             ...
             <label for="grantpo">Attribute: </label> <b class="option_value">\
                 ...
                 <input type="hidden" class="form-control"   name="configure_attribute_name[]" value="'+attributeArray[i]+'">\
                                   ...
                                   \
                                     ...
                                     <select name="configure_price_type[]"  id="product_option_2_type"  class="select form-control required-option-select" title=""><option value="fixed">Fixed</option><option value="percent">Percent</option></select>\
                                     \
                                 </div>\
                                </div>\
                                 </div></div>';               
