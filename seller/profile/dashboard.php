...
$site_title = "Seller Dashboard | Jewelry at Home";
...
// echo $login_id;
    $result_orders = $dbComObj->viewData($conn, "`orders`", "*", "1 and `order_status`='1' and seller_id ='$login_id'");
    $num_orders = $dbComObj->num_rows($result_orders);

    $result_products = $dbComObj->viewData($conn, "`products`", "*", "1 and `status`='1' and added_user_type = 'Seller' and `added_by`='$login_id' and `delete`='0'");
...
<!--            <div class="col-sm-6 col-md-3">
                <div class="panel-stat3 bg-danger">
                    <h2 class="m-top-none" id="userCount">402</h2>
