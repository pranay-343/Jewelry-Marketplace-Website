                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <button type="button" class="btn btn-success srSubmitBtn" onclick="formSubmit('changpass', 'pass_result', '<?php echo SELLER_URL; ?>profile/profile_operations.php')">Change Password</button>
