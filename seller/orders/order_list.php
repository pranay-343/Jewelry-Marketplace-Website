...
$site_title = "Seller Orders | Manage Orders | MarketPlace at Home";
                    ...
                    <div class="x_content"><div id="result1"></div>
                        <div class="table-responsive">
                            ...
                            <table id="testTable" class="table table-vcenter table-condensed table-bordered" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                                   ...
                                   data-show-footer="true" data-height="400" data-url="<?php echo SELLER_URL; ?>orders/fetchinfDataFromTables.php?a=orders" data-query-params="queryParams"
...
<script>
    ...
    {
        // alert(2);
        $.post('<?php echo SELLER_URL; ?>orders/order_operations.php', {a: a, val: val, todo: '<?php echo base64_encode('OrderStatus'); ?>'}, function (data) {
            //  $('#errorMsg').html(data);
