...
?>>
    ...
    -->
    <?php
    if (!isset($_SESSION['DH_admin_id']) && $_SESSION['DH_admin_id'] = "") {
        echo '<h2 style="color: white;">Error Sorry, you don’t have permission to access this page.
            <a href="' . SELLER_URL . '/dashboard/"><i class="gi gi-leaf sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide"> GO to Dashboard</span></a></h2>
          ';
        die;
    } else if ($_SESSION['DH_admin_id'] == '') {
                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
                            <a href="<?php echo ADMIN_URL ?>myprofile/">
                                <?php
                                $ck_order_qry12 = $dbComObj->viewData($conn, "admin", "*", " status = '1' AND id = '" . $_SESSION['DH_admin_id'] . "'");
                        ...
                        <div class="sidebar-user-name"><?php echo $_SESSION['DH_admin_name']; ?></div>
                        <div class="sidebar-user-links">
                            <a href="<?php echo ADMIN_URL; ?>myprofile/" data-toggle="tooltip" data-placement="bottom" title="Profile"><i class="gi gi-user"></i></a>
                        ...
                        <ul class="sidebar-nav">
                            ...
                            foreach ($primary_nav as $key => $link) {
                                ...
                                if ($template['active_page'] == 'dashboard.php') {
                                    $template['active_page'] = ADMIN_URL . 'dashboard/';
                                }

                                if ($template['active_page'] == 'changepass.php') {
                                    $template['active_page'] = ADMIN_URL . 'profile-password/';
                                }
                                if ($template['active_page'] == 'shipping-and-return.php') {
                                    $template['active_page'] = ADMIN_URL . 'shipping-and-return/';
                                }

                                if ($template['active_page'] == 'edit_profile.php') {
                                    $template['active_page'] = ADMIN_URL . 'myprofile/';
                                }
                               
                                  if ($template['active_page'] == 'contest.php') {
                                    $template['active_page'] = ADMIN_URL . 'contests/';
                                }
                                if ($template['active_page'] == 'view-contest.php') {
                                    $template['active_page'] = ADMIN_URL . 'contests/';
                                }
                                 if ($template['active_page'] == 'pending_participate_list.php') {
                                    $template['active_page'] = ADMIN_URL . 'contests/pending_contest_participate/';
                                }
                                // category pages
                                if ($template['active_page'] == 'category.php') {
                                    $template['active_page'] = ADMIN_URL . 'category/add-category/';
                                }

                                if ($template['active_page'] == 'orders.php') {
                                    $template['active_page'] = ADMIN_URL . 'orders/';
                                }
                                if ($template['active_page'] == 'product_metal_list.php') {
                                    $template['active_page'] = ADMIN_URL . 'product-metals/';
                                }

                                if ($template['active_page'] == 'brand_list.php') {
                                    $template['active_page'] = ADMIN_URL . 'brands/';
                                }

                                if ($template['active_page'] == 'category_list.php') {
                                    $template['active_page'] = ADMIN_URL . 'category/category-list/';
                                }

                                //user customers pages
                                if ($template['active_page'] == 'users.php') {
                                    $template['active_page'] = ADMIN_URL . 'users/new-user/';
                                }

                                if ($template['active_page'] == 'view-users.php') {
                                    $template['active_page'] = ADMIN_URL . 'users/';
                                }
                                
                              
                                if ($template['active_page'] == 'view-sellers.php') {
                                    $template['active_page'] = ADMIN_URL . 'sellers/';
                                }

                                //products  pages
                                if ($template['active_page'] == 'product.php') {
                                    $template['active_page'] = ADMIN_URL . 'products/new-product/';
                                }

                                if ($template['active_page'] == 'view-products.php') {
                                    $template['active_page'] = ADMIN_URL . 'products/';
                                }

                                //attribute  pages
                                if ($template['active_page'] == 'attribute_list.php') {
                                    $template['active_page'] = ADMIN_URL . 'attributes/';
                                }
                                if ($template['active_page'] == 'attribute.php') {
                                    $template['active_page'] = ADMIN_URL . 'attributes/';
                                }


                                if ($template['active_page'] == 'attribute_list_set.php') {
                                    $template['active_page'] = ADMIN_URL . 'attributes-set/';
                                }
                                if ($template['active_page'] == 'attribute_set.php') {
                                    $template['active_page'] = ADMIN_URL . 'attributes-set/';
                                }
        ...
        <div id="main-container">
            ...
            ?>">
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    $condition_notify = "1 and notify_user_id='" . $_SESSION['DH_admin_id'] . "' and user_type='" . $User_type . "' and  `is_read` = '0'  "; // and `status` = '0'
                    ...
                    <li class="dropdown">
                        ...
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="<?php echo $src; ?>" alt="avatar"> <?php echo $_SESSION['DH_admin_name']; ?> <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="<?php echo ADMIN_URL; ?>myprofile/"><i class="fa fa-user fa-fw pull-right"></i> Profile </a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                function NotificationIsread(a, b)
                {
                    ...
                    $.post('<?php echo BASE_URL; ?>controller/notification_operations.php', {a: a, b: b, mode: '<?php echo base64_encode('IsreadNotification'); ?>'}, function (data) {
                        var notify_count = parseInt($('#notifyajcount').text());
                           if(isNaN(notify_count) || notify_count > 0) {
