                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <ul class="sign-link pull-right text-right">
                                                    ...
                                                    <li><a href="<?php echo BASE_URL; ?>whislist/"><i class="fa fa-heart"></i>
                                                       (<span class="total_item_wishlist"><?php if ($total_item_wishlist) echo $total_item_wishlist; else echo 0; ?></span>)</a></li>
                                                    <li><a href="<?php echo BASE_URL; ?>cart/"><img src="<?php echo BASE_URL; ?>frontend/img/bag.png">
                                                                Bag (<span class="total_item_cart"><?php if ($total_item_cart) echo $total_item_cart; else echo 0; ?></span>) </a></li>
                                                    <li class="dropdown">
